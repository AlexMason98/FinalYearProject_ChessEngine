...
class TestRook {
  ...
  void test7() {
    ...
    Board.board.map.setValue("piecePos", "3A", "WhitePawn2");
    try {
      System.out.println("Test 7");
      rook.moveRook("White", "WhiteRook1", "3A");
      assertEquals(Board.board.map.getPieceOrOccupation("piecePos", "3A"), "WhitePawn2");
      Board.board.map.printStatus();
    } catch (InvalidPieceException e) {
      e.printStackTrace();
      fail("Exception Thrown");
  ...
  void test8() {
    ...
    the WhiteRook has a clear path to move. */
    Board.board.map.setValue("piecePos", "2A", "null");
    Board.board.map.setValue("piecePos", "3A", "WhitePawn1");
  ...
  void test9() {
    ...
    try {
      ...
      assertEquals(Board.board.map.getPieceOrOccupation("piecePos", "7A"), "WhiteRook1");
